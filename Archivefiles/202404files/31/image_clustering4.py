    ...
    with open(output_csv, mode='w', newline='') as file:
        ...
        for filename in os.listdir(input_folder):
            if filename.endswith('.png'):
                ...
                init_centroids = np.array([[47, 297, 0], [143, 297, 0], [47, 367, 0], [143, 367, 0], [98,330,0]])
...
if __name__ == '__main__':
    ...
    output_images_folder = 'D://A//1 InsoleDataset//WMT//Kmean_Mask//LeftPNG//001//sorted_keypoint_1//'
    mask_path = 'D://A//1 InsoleDataset//WMT//Kmean_Mask//LeftPNG//001//combined_mask1.png'
    output_csv = 'D://A//1 InsoleDataset//WMT//Kmean_Mask//LeftPNG//001//output1.csv'
    # Create the output folder if it doesn't exist
    if not os.path.exists(output_images_folder):
        os.makedirs(output_images_folder)
    coord_weight_x = 1  # Adjust the coordinate weight here

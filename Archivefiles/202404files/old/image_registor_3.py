...
def main():
    size_index = 'PNG_Left//Left_10.png'
    folder_index = 'LeftResizePNG//001//'
    object_image_path = 'D://A//A_Process_data//AutoCAD//' + size_index
    points_image_folder = 'D://A//A_Process_data//WATMat//3Averaged//' + folder_index
    modified_image_folder = 'D://A//A_Process_data//WATMat//4Modified//' + folder_index

    # Define the path for the processed points images
    processed_points_image_folder = 'D://A//A_Process_data//WATMat//5Processed_Points//' + folder_index

"""
The data converted by WMT software is raw data, all the FSR data are saved as string, seperated by space, and placed in the first column.
This script will delete the header data as well as frame information.
The processed data have 97 lines and 65 columns as one frame.
The first line and the first column of each frame contain line and column ID, the rest of frame contain data array with size of 96 lines and 64 columns.
"""
import os
import csv

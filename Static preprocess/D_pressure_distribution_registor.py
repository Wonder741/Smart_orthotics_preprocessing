...
def main():
    ...
    if index1 == 'left':
        ...
        id_file = 'right_' + id_index + '.png'
    mask_dir = 'D:\\A\\A_Process_data\\3DScan\\4Processed'
    object_image_path = os.path.join(mask_dir, side_index, id_index, id_file)
    ...
    csv_file_name = os.path.join('D:\\A\\A_Process_data\\WATMat', 'pressure_process_result.csv')
